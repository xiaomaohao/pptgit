...
Intro panel:source/console/environment/files/plots/packages/help/viewer
...
+ readxl: readxl reads excel files (both .xls and .xlsx).
...
# Overview of selection features_1
...
教学反思，学生普通对于R语言熟练程度和理解的程度还比较低，所以细小的错误很多，影响了课程的进度，所以应当在课前明确课下预习的内容。并要求学习做必要的课下练习。这样才能提高课程的进度与成效。
